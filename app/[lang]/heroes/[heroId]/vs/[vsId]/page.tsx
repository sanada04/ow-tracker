  ...
  function StatRow({
    ...
    return (
      <div className={`grid grid-cols-3 items-center py-3 border-b border-zinc-800/50 last:border-0 ${highlight ? "bg-zinc-800/10" : ""}`}>
        <span className={`text-sm text-right pr-4 tabular-nums ${aWins ? "text-[#f4a029] font-semibold" : "text-zinc-300"}`}>
          {valA ?? "—"}
        </span>
        <span className="text-xs text-center text-zinc-500 uppercase tracking-wider">{label}</span>
        <span className={`text-sm text-left pl-4 tabular-nums ${bWins ? "text-[#f4a029] font-semibold" : "text-zinc-300"}`}>
          {valB ?? "—"}
        </span>
      </div>
    );
        ...
        <div className="ow-card p-6 mb-8">
          <div className="grid grid-cols-3 items-center gap-4">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <Link
                href={`/${lang}/heroes/${heroId}`}
                className="text-xl font-bold text-white hover:text-[#f4a029] transition-colors text-center"
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              ...
              className="ow-card p-4 flex items-center gap-3 hover:border-[#f4a029]/40 transition-colors"
            >
              {portraitA && (
