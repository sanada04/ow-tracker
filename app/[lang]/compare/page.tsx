    ...
    <div className="ow-card overflow-hidden">
      {summary.namecard && (
        <div className="relative h-20 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#101014]" />
        </div>
      )}
      <div className="p-4 flex flex-col items-center text-center gap-2 -mt-6 relative">
        {summary.avatar ? (
          ...
          <div className="w-16 h-16 border border-zinc-700 bg-[#141418] rounded flex items-center justify-center text-2xl font-bold text-zinc-300">
